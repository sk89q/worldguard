...
public final class Entities {
    ...
    public static boolean isChestBoat(EntityType type) {
        return switch (type) {
            case OAK_CHEST_BOAT, DARK_OAK_CHEST_BOAT, SPRUCE_CHEST_BOAT, ACACIA_CHEST_BOAT, CHERRY_CHEST_BOAT,
                 JUNGLE_CHEST_BOAT, MANGROVE_CHEST_BOAT, BIRCH_CHEST_BOAT, PALE_OAK_CHEST_BOAT, BAMBOO_CHEST_RAFT -> true;
            default -> false;
        };
    }
